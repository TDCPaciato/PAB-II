...
import com.if5b.mnag.tulisaja.activities.MainActivity;
import com.if5b.mnag.tulisaja.databinding.ActivityInsertBinding;
...
public class InsertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validateFields()) {
                    String username = Utilities.getValue(InsertActivity.this, MainActivity.KEY_USERNAME);
    ...
    private void editPost(int postId, String content) {
        Utilities.().updatePost(MainActivity.KEY_API, postId, content).enqueue(new Callback<ValueNoData>() {
            @Override
