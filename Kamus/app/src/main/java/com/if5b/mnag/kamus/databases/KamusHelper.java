...
import static com.if5b.mnag.kamus.databases.DatabaseContract.EnglishIndonesiaColumns.ENGLISH_INDONESIA_DESCRIPTION;
import static com.if5b.mnag.kamus.databases.DatabaseContract.EnglishIndonesiaColumns.ENGLISH_INDONESIA_TITLE;
import static com.if5b.mnag.kamus.databases.DatabaseContract.TABLE_ENGLISH_INDONESIA;
...
public class KamusHelper {
    ...
    public ArrayList<Kamus> getAllDataEnglishIndonesia(){
        Cursor cursor = database.query(TABLE_ENGLISH_INDONESIA,
                null,
                null,
                null,
                null,
    ...
    public long insertDataEnglishIndonesia(Kamus kamus){
        ...
        return database.update(TABLE_ENGLISH_INDONESIA, cv,
                _ID + "= '" + kamus.getId() + "'", null);
    }

    public int deleteDataEnglishIndonesia(int id){
        return database.delete(TABLE_ENGLISH_INDONESIA,
                _ID + "= '" + id + "'", null);
    }
